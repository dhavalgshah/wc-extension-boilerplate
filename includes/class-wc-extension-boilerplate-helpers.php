<?php
/**
 * WC_Extension_Boilerplate_Helpers class
 *
 * @class 	WC_Extension_Boilerplate_Order
 * @version 0.1.0
 * @since   0.1.0
 */
...
class WC_Extension_Boilerplate_Helpers {
	...
	public static function is_product_checkbox( $product_id ) {
		if ( 'yes' == get_post_meta( $product_id, '_wc_extension_boilerplate', true ) ) {
			return true;
		} else {
			return false;
		}
	...
	public static function get_sample_number( $product_id ) {
		return floatval( get_post_meta( $product_id, '_wc_extension_boilerplate_number', true ) );
	}
	...
	public static function get_sample_textbox( $product_id ) {
		return get_post_meta( $product_id, '_wc_extension_boilerplate_textbox', true );
	}
